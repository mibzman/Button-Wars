...
public class DoubleDone extends Activity {
    ...
    public void buttonListiner() {
        Button nextm = (Button) findViewById(R.id.nextm);
        nextm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = getIntent();
                int lvl = intent2.getIntExtra("message", 0);
                if (lvl >= 19) {
                    sendEnd();
                } else {
                    sendDiffLvl();
        ...
        Button nextma = (Button) findViewById(R.id.nextma);
        nextma.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = getIntent();
                int lvl = intent2.getIntExtra("message", 0);
        ...
        Button rematcha = (Button) findViewById(R.id.rematcha);
        rematcha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendSameLvl();
            }
    ...
    public void sendEnd() {
        Intent intent2 = getIntent();
        int lvl = intent2.getIntExtra("message", 0);
        Intent intentEnd = new Intent(this, DoubleEnd.class);
        intentEnd.putExtra("theLvl", lvl);
    ...
    public void getwinner() {
        Intent intent2 = getIntent();
        int result = intent2.getIntExtra("wilma", 0);
        switch (result) {
            case 1:
                TextView player1Result = (TextView) findViewById(R.id.won);
                player1Result.setText("WON!");
                TextView player2Result = (TextView) findViewById(R.id.wona);
                player2Result.setText("LOST!");
                break;
            case 0:
                TextView player1Result2 = (TextView) findViewById(R.id.won);
                player1Result2.setText("LOST!");
                TextView player2Result2 = (TextView) findViewById(R.id.wona);
                player2Result2.setText("WON!");
        }

...
public class Done extends Activity {
    ...
    public void buttonListiner() {
        ...
        nextm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int lvl = intent20.getIntExtra("singleLvl", 0);
                if (result < 1) {
                    nopeDialog();
                } else if (lvl > 19) {
                    sendEnd();
    ...
    public void nopeDialog() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                context2);
        alertDialogBuilder.setTitle("You lost.  Win the level to continue.");
        alertDialogBuilder
                .setCancelable(false)
    ...
    public void sendSameLvl() {
        Intent intent20 = getIntent();
        int lvl = intent20.getIntExtra("singleLvl", 0);
        Intent intent30 = new Intent(this, Single.class);
        intent30.putExtra("corn", false);
        intent30.putExtra("theSingleLvl", lvl);
    ...
    public void getwinner() {
        Intent intent20 = getIntent();
        result = intent20.getIntExtra("betty", 0);
        switch (result) {
            case 1:
                TextView player1Result = (TextView) findViewById(R.id.wonz);
                player1Result.setText("WON!");
                break;
            case 0:
                TextView player1Result2 = (TextView) findViewById(R.id.wonz);
